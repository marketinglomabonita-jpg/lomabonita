-- Fase 9 — re-seed idempotente de experiencias corporativas.
-- Motivo (medido 2026-09-17): el wizard de /experiencias-corporativas aparece sin
-- opciones en el paso 1. Causa: el seed 0012 no está presente en la base real
-- (el proyecto estuvo pausado / el seed nunca se aplicó). Estas mismas filas se
-- insertan aquí con `on conflict do nothing`, de modo que aplicar esta migración
-- deja los tipos y addons disponibles sin duplicar nada si ya existieran.
